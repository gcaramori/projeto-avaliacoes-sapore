...
app.get('/listar', (req, res) => {
    ...
    db.collection('avaliacoes').aggregate([{
        '$facet': {
            ...
            'pergunta3_filtroS': [{ '$match': { 'setor': filtroSetor } }, { '$group': { '_id': '$pergunta3', 'total': { '$sum': 1 } } }, { '$project': { '_id': 0, 'resposta': '$_id', 'total': '$total' } }, ],
            'pergunta4_filtroS': [{ '$match': { 'setor': filtroSetor } }, { '$group': { '_id': '$pergunta4', 'total': { '$sum': 1 } } }, { '$project': { '_id': 0, 'resposta': '$_id', 'total': '$total' } }, ],
            'pergunta5_filtroS': [{ '$match': { 'setor': filtroSetor } }, { '$group': { '_id': '$pergunta5', 'total': { '$sum': 1 } } }, { '$project': { '_id': 0, 'resposta': '$_id', 'total': '$total' } }, ],
            'pergunta6_filtroS': [{ '$match': { 'setor': filtroSetor } }, { '$group': { '_id': '$pergunta6', 'total': { '$sum': 1 } } }, { '$project': { '_id': 0, 'resposta': '$_id', 'total': '$total' } }, ],
            'pergunta7_filtroS': [{ '$match': { 'setor': filtroSetor } }, { '$group': { '_id': '$pergunta7', 'total': { '$sum': 1 } } }, { '$project': { '_id': 0, 'resposta': '$_id', 'total': '$total' } }, ],
            'pergunta8_filtroS': [{ '$match': { 'setor': filtroSetor } }, { '$group': { '_id': '$pergunta8', 'total': { '$sum': 1 } } }, { '$project': { '_id': 0, 'resposta': '$_id', 'total': '$total' } }, ],
            'pergunta9_filtroS': [{ '$match': { 'setor': filtroSetor } }, { '$group': { '_id': '$pergunta9', 'total': { '$sum': 1 } } }, { '$project': { '_id': 0, 'resposta': '$_id', 'total': '$total' } }, ],

            //bloco com filtro por turno
            'pergunta1_filtroT': [{ '$match': { 'setor': filtroTurno } }, { '$group': { '_id': '$pergunta1', 'total': { '$sum': 1 } } }, { '$project': { '_id': 0, 'resposta': '$_id', 'total': '$total' } }, ],
            'pergunta2_filtroT': [{ '$match': { 'setor': filtroTurno } }, { '$group': { '_id': '$pergunta2', 'total': { '$sum': 1 } } }, { '$project': { '_id': 0, 'resposta': '$_id', 'total': '$total' } }, ],
            'pergunta3_filtroT': [{ '$match': { 'setor': filtroTurno } }, { '$group': { '_id': '$pergunta3', 'total': { '$sum': 1 } } }, { '$project': { '_id': 0, 'resposta': '$_id', 'total': '$total' } }, ],
            'pergunta4_filtroT': [{ '$match': { 'setor': filtroTurno } }, { '$group': { '_id': '$pergunta4', 'total': { '$sum': 1 } } }, { '$project': { '_id': 0, 'resposta': '$_id', 'total': '$total' } }, ],
            'pergunta5_filtroT': [{ '$match': { 'setor': filtroTurno } }, { '$group': { '_id': '$pergunta5', 'total': { '$sum': 1 } } }, { '$project': { '_id': 0, 'resposta': '$_id', 'total': '$total' } }, ],
            'pergunta6_filtroT': [{ '$match': { 'setor': filtroTurno } }, { '$group': { '_id': '$pergunta6', 'total': { '$sum': 1 } } }, { '$project': { '_id': 0, 'resposta': '$_id', 'total': '$total' } }, ],
            'pergunta7_filtroT': [{ '$match': { 'setor': filtroTurno } }, { '$group': { '_id': '$pergunta7', 'total': { '$sum': 1 } } }, { '$project': { '_id': 0, 'resposta': '$_id', 'total': '$total' } }, ],
            'pergunta8_filtroT': [{ '$match': { 'setor': filtroTurno } }, { '$group': { '_id': '$pergunta8', 'total': { '$sum': 1 } } }, { '$project': { '_id': 0, 'resposta': '$_id', 'total': '$total' } }, ],
            'pergunta9_filtroT': [{ '$match': { 'setor': filtroTurno } }, { '$group': { '_id': '$pergunta9', 'total': { '$sum': 1 } } }, { '$project': { '_id': 0, 'resposta': '$_id', 'total': '$total' } }, ],
            ...
            'pergunta3_filtroST': [{ '$match': { 'setor': filtroSetor, 'turno': filtroTurno } }, { '$group': { '_id': '$pergunta3', 'total': { '$sum': 1 } } }, { '$project': { '_id': 0, 'resposta': '$_id', 'total': '$total' } }, ],
            'pergunta4_filtroST': [{ '$match': { 'setor': filtroSetor, 'turno': filtroTurno } }, { '$group': { '_id': '$pergunta4', 'total': { '$sum': 1 } } }, { '$project': { '_id': 0, 'resposta': '$_id', 'total': '$total' } }, ],
            'pergunta5_filtroST': [{ '$match': { 'setor': filtroSetor, 'turno': filtroTurno } }, { '$group': { '_id': '$pergunta5', 'total': { '$sum': 1 } } }, { '$project': { '_id': 0, 'resposta': '$_id', 'total': '$total' } }, ],
            'pergunta6_filtroST': [{ '$match': { 'setor': filtroSetor, 'turno': filtroTurno } }, { '$group': { '_id': '$pergunta6', 'total': { '$sum': 1 } } }, { '$project': { '_id': 0, 'resposta': '$_id', 'total': '$total' } }, ],
            'pergunta7_filtroST': [{ '$match': { 'setor': filtroSetor, 'turno': filtroTurno } }, { '$group': { '_id': '$pergunta7', 'total': { '$sum': 1 } } }, { '$project': { '_id': 0, 'resposta': '$_id', 'total': '$total' } }, ],
            'pergunta8_filtroST': [{ '$match': { 'setor': filtroSetor, 'turno': filtroTurno } }, { '$group': { '_id': '$pergunta8', 'total': { '$sum': 1 } } }, { '$project': { '_id': 0, 'resposta': '$_id', 'total': '$total' } }, ],
            'pergunta9_filtroST': [{ '$match': { 'setor': filtroSetor, 'turno': filtroTurno } }, { '$group': { '_id': '$pergunta9', 'total': { '$sum': 1 } } }, { '$project': { '_id': 0, 'resposta': '$_id', 'total': '$total' } }, ],
    ...
    if (filtroSetor == '' && filtroPergunta == '' && filtroTurno != '') {
        data = results[0].comFiltroTurno
        titulo = 'Avaliação das perguntas filtradas por turno'
    }
    if (filtroSetor != '' && filtroPergunta == '' && filtroTurno != '') {
        ...
        <body>
            ...
            <script>
                ...
                let grafico = new Chart(meuGrafico, {
                    type:'pie',
                    data:{
                        labels: ['Muito bom','Bom','Regular','Ruim','Muito ruim','Em branco'],
                        datasets: [{
                            label:'Avaliações',
                            data:[
                                ${resume.resposta1},
